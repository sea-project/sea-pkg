// Package sm2 crypto/x509 add sm2 support
package sm2
...
const (
	...
	RIPEMD160                  // import golang.org/x/crypto/ripemd
...
// InsecureAlgorithmError SignatureAlgorithm类型
...
// UnhandledCriticalExtension 未处理的CriticalExtension
...
// CertificateRequest represents a PKCS #10, certificate signature request.CertificateRequest表示一个PKCS #10证书签名请求。
...
// ReadCertificateRequestFromMem []byte返回证书签名请求
...
//ReadCertificateRequestFromPem string返回证书签名请求
...
// CreateCertificateRequestToMem 创建证书签名
...
// CreateCertificateRequestToPem 创证书签名
